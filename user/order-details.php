...
<div class="page-container">
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
            ...
            $orderId = $_GET['id'];
            $sql = $mysqli->query("select a.*,b.goods_name,d.rack_name from order_details a LEFT JOIN goods_info b on a.goods_id=b.id LEFT JOIN order_info c on a.order_id=c.id LEFT JOIN rack_info d on a.rack_uuid=d.uuid where c.order_id='$orderId'");
