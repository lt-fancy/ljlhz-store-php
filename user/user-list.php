                ...
                <?php
                    ...
                    for($i=0;$i<$datarow;$i++){
                        ...
                        echo "<tr class='text-c'>
                                ...
                                <td>$balance</td>
                                <td>$time</td>
                                <td class='f-14 td-manage'><a style='text-decoration:none' onClick='charge(this.parentNode)' href='javascript:;' title='余额充值'><i class='Hui-iconfont' style='font-size: large'>&#xe615;</i></a></td>
                            </tr>";
                    }
                ?>
			</tbody>
...
<script type="text/javascript">
    ...
    function charge(ele){
        var id = $(ele).siblings('.user_id').html();
        var phone = $(ele).siblings('.phone').html();
        var index = layer.open({
            type: 2,
            area: ['500px','300px'],
            title: '余额充值',
            content: 'balance-charge.php?id='+id+'&phone='+phone
        });
    }
</script> 
</body>
