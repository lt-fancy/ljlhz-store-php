...
//Connect to mysql
//$db->connect("sh-cdb-ajjk5bx6.sql.tencentcdb.com:63541", "root", "a8594588A", "bianli");
//$db->connect("rm-bp13qqa6glmq9p9u2.mysql.rds.aliyuncs.com", "root", "a8594588A", "bianli");
$db->connect("localhost", "root", "a8594588", "warehouse");
