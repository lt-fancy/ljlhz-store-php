...
<div class="page-container">
    <form method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="eanCode" type="text" class="input-text" value="<?PHP echo $eanCode;?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品规格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="guige" type="text" class="input-text" value="<?PHP echo $guige;?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品单位：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="unit" type="text" class="input-text" value="<?PHP echo $unit;?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品分类：</label>
            <div class="formControls col-xs-8 col-sm-9">
				<input id="category" type="text" class="input-text" value="<?PHP echo $category;?>">
            </div>
        </div>
        <div class="row cl">
    ...
    $(window).load(function () {
        if(id > 0){
            ...
            var $li = $(
                ...
                "<img style='width: 210px;height: 143px;' src='"+image+"'>"+
...
//        fileSingleSizeLimit:409600
    ...
    function save() {
        ...
        $.ajax({
            ...
            dataType: "json",
            data: {"id": id,"eanCode":eanCode, "name": name,"guige":guige,"unit":unit,"category":category,"image":image},
